...
1. Consider a consumer having a utility function $U = 2x+y$ where x and y are two commodities. Suppose that the price ofx and y are both Rs. 5 each and the consumer’s income is Rs. 100. In equilibrium, the consumer will consume the bundle
...
2. With quantity of x on the horizontal axis, the Engel curve for commodity x corresponding to the utility function $U=y+f(x)$ will be
