...
3. what will happen if we remove the assumption of constant marginal utility of money from cardinal utility analysis ? 

4. "Cardinal  utility analysis is considered to be inconsistent with it's own assumption." Is above statement is true or false ? Give reason.

**Long Answers** (200-250 words)

5. Explain marshall's measure of consumer surplus ? How it is different from Hicksian measure of consumer surplus. 
    
6. State and explain smiliar asssumptions between cardinal and ordinal utility analysis. 
