...
Plugging in our prices, we Önd that the income-consumption curve is equal to $\frac{y}{x}=\frac{\sqrt4}{\sqrt 9}=\frac{2}{3}$  at these prices. Intuitively, Maria prefers to consume goods x and y in fixed proportions based on their relative prices. As her income increases, the amount of x and y increase, but her preferred proportion does not change.
